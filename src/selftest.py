...
def get_test_data(settings, move_data, i):
    labels = []
    comments = []
    
    if "Start new game" in move_data['move']:
        if move_data['author'] == move_data['owner']:
...
def run_test_case(filename, main_fn):
    ...
    for i in range(len(test_data['moves'])):
        ...
        labels, comments = get_test_data(settings, move_data, i)
        ...
        if result == True:
            print('\u001b[0m    \u001b[1m\u001b[32m✓ \u001b[0m\u001b[37m' + move_data['move'] + '(' + move_data['author'] + ')\u001b[0m')
            passed += 1
        else:
            print('\u001b[0m    \u001b[1m\u001b[31m✗ \u001b[0m\u001b[37m' + move_data['move'] + '(' + move_data['author'] + ')\u001b[1m → \u001b[31m' + reason + '\u001b[0m')
            failed += 1
...
def run(main_fn):
    ...
    print(f'\u001b[1m\u001b[31m   {failed} failed', end='');
